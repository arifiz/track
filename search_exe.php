    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="index.php" class="navbar-brand"><img src="images/logo.png" height="20" width="130"></a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="index.php">Kembali ke Home <span class="sr-only">(current)</span></a></li>
...
<td>".$data['no_kirim']."</td>
<td>".$data['cabang']."</td>
<td>".DateToIndo($data['tgl_masuk'])."</td>
<td>".$data['via']."</td>
<td>".$data['scanning']."</td>
<td>".$data['printing']."</td>
<td>".$data['packing']."</td>
<td>".DateToIndo($data['tgl_kirim'])."</td>
<td>".DateToIndo($data['tgl_terima'])."</td>
<td>".$data['ket']."</td>
</tr>";
}
