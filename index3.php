...
<div class="col-md-12">
	...
	while($b=mysql_fetch_array($brg)){
		...
		<tr>
			...
			<td align="center"><span class="style4"><p align=center><a class="btn btn-block btn-primary btn-xs" onclick="Javascript:window.open('<?php echo "detail.php?id_cabang=$b[id_cabang]";?>','Contoh Window','status=0,toolbar=0,location=0,menubar=0,directories=0,resizable=0,scrollbars=0,width=750,height=340');" width=70 >Detail</p></a></span></td>  
...
";
  ...
  if ($jumlah > 0) {  
    echo '<p><div class="alert alert-warning alert-dismissible"><h5><i class="icon fa fa-check"></i>Ada '.$jumlah.' paket LJK yang masuk.</h5><small>Data yang masuk diurutkan berdasarkan tanggal paket masuk di Detection</small></div></p>';  
...
<!-- End Timer 15/sec refresh -->   
  ...
  <div class="container">
      ...
      <strong>Copyright &copy; 2016 <a href="#">IT Detection</a>.</strong> All rightsreserved.
  </div>
