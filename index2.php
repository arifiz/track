    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="#" class="navbar-brand"><b>DTC</b>TRACKING</a>
...
$hasil = mysql_query("SELECT * FROM utama order by tgl_masuk desc",$id_mysql);
...
{
$warna="#ffffff";
if($baris['tgl_kirim'] != "0000-00-00"){ $warna="ADD8E6"; }
echo "<tr bgcolor=$warna><td align=left>$baris[cabang]</td><td align=left>".DateToIndo($baris['tgl_masuk'])."</td><td align=left>$baris[scanning]</td><td align=left>$baris[printing]</td><td align=left>$baris[packing]</td><td align=left>".DateToIndo($baris['tgl_kirim'])."</td><td align=left>$baris[ket]</td>"; ?></a></td></tr>
...
";
  ...
  if ($jumlah > 0) {  
    echo '<p><div class="alert alert-warning alert-dismissible"><h5><i class="icon fa fa-check"></i>Ada '.$jumlah.' paket LJK yang masuk.</h5></div></p>';  
...
?>
  ...
  <footer class="main-footer">
    <div class="container">
      ...
      <strong>Copyright &copy; 2017 <a href="#">IT Detection</a>.</strong> All rights
      reserved.
    </div>
    <!-- /.container -->
  </footer>
